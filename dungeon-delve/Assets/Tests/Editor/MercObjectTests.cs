...
public class MercObjectTests 
{
    ...
    public void GetHealthReturnsProperHealth_Armor()
    {
        ...
        testMerc.armor = testArmor; //macaroni platemail
        Assert.AreEqual(baseHealth + testArmor.GetHealth(), testMerc.GexMaxHealth());
    }
    ...
    {
        int baseHealth = testMerc.GetMaxHealth();
        testMerc.weapon = testWeapon; //macaroni platemail
        Assert.AreEqual(baseHealth + testWeapon.GetHealth(), testMerc.GexMaxHealth());
    }
    ...
    public void GetHealthReturnsProperHealth_ArmorAndWeapon()
    {
        ...
        testMerc.weapon = testWeapon; //macaroni platemail
        testMerc.armor = testArmor; //macaroni platemail
        Assert.AreEqual(baseHealth + testWeapon.GetHealth() + testArmor.GetHealth(), testMerc.GexMaxHealth());
    }
}
